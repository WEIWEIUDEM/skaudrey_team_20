...
class Cleaner():
    ...
    '''
    def __init__(self,method='num',dropOutlierRatio=0.1,discreteMethod='interval'):
        self.df = None
    ...
    def rescaleData(self):
        ...
        self.df['numFollowersLog'] = self.df['numFollowers']
        self.df['numPeopleFollowingLog'] = self.df['numPeopleFollowing']
        self.df['numStatUpdateLog'] = self.df['numStatUpdate']
        self.df['numDMessageLog'] = self.df['numDMessage']
        self.df['avgClickLog'] = self.df['avgClick']
